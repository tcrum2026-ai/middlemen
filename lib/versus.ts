...
export const VERSUS: Versus[] = [
  {
    ...
    title: "Middlemen vs an AI voice receptionist",
    subhead:
    ...
    together:
      "Run both. Let the voice service catch the phone and let Middlemen handle the written channels — and the " +
    ...
    metaDescription:
      "An honest comparison of Middlemen and AI voice receptionists: what each one actually solves, where voice AI " +
      "wins, and why running both often makes sense.",
  },
  {
    slug: "answering-service",
    name: "Human answering services",
    title: "Middlemen vs a human answering service",
    subhead:
    ...
    together:
      "Plenty of businesses keep an answering service for the phone line and put Middlemen on every written " +
    ...
    metaDescription:
      "Middlemen compared with a human answering service: cost, speed, what each one can actually complete, and when " +
      "keeping both is the right call.",
  },
  {
    slug: "website-chatbot",
    name: "Website chatbots",
    title: "Middlemen vs a website chatbot",
    subhead:
    ...
    metaDescription:
      "Middlemen compared with website chatbots: why a tool-using assistant that books, quotes and escalates is a " +
      "different category from an FAQ widget.",
  },
  {
    slug: "hiring-a-receptionist",
    name: "Hiring a receptionist",
    title: "Middlemen vs hiring someone",
    ...
    verdict:
      ...
      "miserable.",
    metaDescription:
      "Middlemen compared with hiring a receptionist: what software genuinely covers, what it can't, and why most " +
